...
class bicycle_kin_fblin
{
    public:
        ...
        void reference_transformation_position(double xref, double yref, double &xPref, double &yPref);
        void reference_transformation_velocity(double dxref, double dyref, double dthref, double &dxPref, double &dyPref);
